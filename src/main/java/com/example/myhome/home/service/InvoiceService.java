...
public class InvoiceService {
    ...
    @Autowired private AccountServiceImpl apartmentAccountService;
    ...
    public InvoiceTemplate findDefaultTemplate() {return invoiceTemplateRepository.getDefaultTemplate().orElseThrow();}
