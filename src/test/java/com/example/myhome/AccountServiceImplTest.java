...
public class AccountServiceImplTest {
    ...
    void calculatesBalancesAndDebtsCorrectly() {
        ...
        accountServiceImpl.getSumOfAccountBalances();
        verify(accountRepository).findAll();
        assertThat(accountServiceImpl.getSumOfAccountBalances()).isEqualTo(total_positive_balance);
        assertThat(accountServiceImpl.getSumOfAccountDebts()).isEqualTo(total_debt);
    }
